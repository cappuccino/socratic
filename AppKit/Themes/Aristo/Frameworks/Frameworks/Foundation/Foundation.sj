@STATIC;1.0;p;13;CPArray+KVO.ji;9;CPArray.jc;10744;
...
class_addIvars(_1,[new objj_ivar("_proxyObject"),new objj_ivar("_key"),new objj_ivar("_insertSEL"),new objj_ivar("_insert"),new objj_ivar("_removeSEL"),new objj_ivar("_remove"),new objj_ivar("_replaceSEL"),new objj_ivar("_replace"),new objj_ivar("_objectAtIndexSEL"),new objj_ivar("_objectAtIndex"),new objj_ivar("_countSEL"),new objj_ivar("_count"),new objj_ivar("_accessSEL"),new objj_ivar("_access"),new objj_ivar("_setSEL"),new objj_ivar("_set")]);
...
if(objj_msgSend(_proxyObject,"respondsToSelector:",selector)){
_insert=objj_msgSend(_proxyObject,"methodForSelector:",selector);
}
_removeSEL=sel_getName("removeObjectFrom"+_10+"AtIndex:");
if(objj_msgSend(_proxyObject,"respondsToSelector:",selector)){
_remove=objj_msgSend(_proxyObject,"methodForSelector:",selector);
}
_replaceSEL=sel_getName("replaceObjectFrom"+_10+"AtIndex:withObject:");
if(objj_msgSend(_proxyObject,"respondsToSelector:",selector)){
_replace=objj_msgSend(_proxyObject,"methodForSelector:",selector);
}
_objectAtIndexSEL=sel_getName("objectIn"+_10+"AtIndex:");
if(objj_msgSend(_proxyObject,"respondsToSelector:",selector)){
_objectAtIndex=objj_msgSend(_proxyObject,"methodForSelector:",selector);
}
_countSEL=sel_getName("countOf"+_10);
if(objj_msgSend(_proxyObject,"respondsToSelector:",selector)){
_count=objj_msgSend(_proxyObject,"methodForSelector:",selector);
}
_accessSEL=sel_getName(_key);
if(objj_msgSend(_proxyObject,"respondsToSelector:",selector)){
_access=objj_msgSend(_proxyObject,"methodForSelector:",selector);
}
_setSEL=sel_getName("set"+_10+":");
if(objj_msgSend(_proxyObject,"respondsToSelector:",selector)){
_set=objj_msgSend(_proxyObject,"methodForSelector:",selector);
}
return _c;
}
...
objj_msgSend(_self,"_setRepresentedObject:",_23);
}
...
objj_msgSend(_self,"_setRepresentedObject:",_28);
}
...
objj_msgSend(_self,"_setRepresentedObject:",_2b);
}
...
objj_msgSend(_self,"_setRepresentedObject:",_2f);
}
...
objj_msgSend(_self,"_setRepresentedObject:",_34);
}
...
with(_88){
if(objj_msgSend(isa,"instanceMethodForSelector:",_89)==objj_msgSend(NSArray,"instanceMethodForSelector:",_89)){
...
with(_8e){
if(objj_msgSend(isa,"instanceMethodForSelector:",_8f)==objj_msgSend(NSArray,"instanceMethodForSelector:",_8f)){
objj_msgSend(CPException,"raise:reason:",CPInvalidArgumentException,"Unsupported method on CPArray");
}else{
...
p;9;CPArray.ji;10;CPObject.ji;9;CPRange.ji;14;CPEnumerator.ji;18;CPSortDescriptor.ji;13;CPException.jc;17767;
...
p;10;CPBundle.ji;10;CPObject.ji;14;CPDictionary.ji;14;CPURLRequest.jc;3072;
...
}),new objj_method(sel_getUid("infoDictionary"),function(_11,_12){
with(_11){
return info;
}
}),new objj_method(sel_getUid("objectForInfoDictionaryKey:"),function(_13,_14,_15){
with(_13){
return objj_msgSend(info,"objectForKey:",_15);
}
}),new objj_method(sel_getUid("loadWithDelegate:"),function(_16,_17,_18){
with(_16){
_16._delegate=_18;
_16._infoConnection=objj_msgSend(CPURLConnection,"connectionWithRequest:delegate:",objj_msgSend(CPURLRequest,"requestWithURL:",objj_msgSend(_16,"bundlePath")+"/Info.plist"),_16);
}
}),new objj_method(sel_getUid("connection:didReceiveData:"),function(_19,_1a,_1b,_1c){
with(_19){
if(_1b===_19._infoConnection){
info=CPPropertyListCreateFromData(objj_msgSend(CPData,"dataWithString:",_1c));
objj_msgSend(CPURLConnection,"connectionWithRequest:delegate:",objj_msgSend(CPURLRequest,"requestWithURL:",objj_msgSend(_19,"bundlePath")+"/"+objj_msgSend(_19,"objectForInfoDictionaryKey:","CPBundleExecutable")),_19);
}else{
objj_decompile(objj_msgSend(_1c,"string"),_19);
var _1d=new objj_context();
if(objj_msgSend(_delegate,"respondsToSelector:",sel_getUid("bundleDidFinishLoading:"))){
_1d.didCompleteCallback=function(){
objj_msgSend(_delegate,"bundleDidFinishLoading:",_19);
};
}
var _1e=objj_msgSend(_19,"objectForInfoDictionaryKey:","CPBundleReplacedFiles"),_1f=_1e.length;
while(_1f--){
_1d.pushFragment(fragment_create_file(objj_msgSend(_19,"bundlePath")+"/"+_1e[_1f],new objj_bundle(""),YES,NULL));
}
_1d.evaluate();
}
}
}),new objj_method(sel_getUid("connectionDidFinishLoading:"),function(_20,_21,_22){
with(_20){
}
})]);
class_addMethods(_2,[new objj_method(sel_getUid("alloc"),function(_23,_24){
with(_23){
return new objj_bundle;
}
}),new objj_method(sel_getUid("bundleWithPath:"),function(_25,_26,_27){
with(_25){
return objj_getBundleWithPath(_27);
}
}),new objj_method(sel_getUid("bundleForClass:"),function(_28,_29,_2a){
with(_28){
return objj_bundleForClass(_2a);
}
}),new objj_method(sel_getUid("mainBundle"),function(_2b,_2c){
with(_2b){
...
p;14;CPDictionary.ji;10;CPObject.ji;14;CPEnumerator.ji;13;CPException.jc;6055;
...
with(_28){
var _2b=_buckets[_2a];
return (_2b===undefined)?nil:_2b;
}
}),new objj_method(sel_getUid("removeAllObjects"),function(_2c,_2d){
with(_2c){
_keys=[];
count=0;
_buckets={};
}
}),new objj_method(sel_getUid("removeObjectForKey:"),function(_2e,_2f,_30){
with(_2e){
dictionary_removeValue(_2e,_30);
}
}),new objj_method(sel_getUid("removeObjectsForKeys:"),function(_31,_32,_33){
with(_31){
for(var i=0,_35=_33.length;i<_35;i++){
dictionary_removeValue(_31,_33[i]);
}
}
}),new objj_method(sel_getUid("setObject:forKey:"),function(_36,_37,_38,_39){
with(_36){
dictionary_setValue(_36,_39,_38);
}
}),new objj_method(sel_getUid("addEntriesFromDictionary:"),function(_3a,_3b,_3c){
with(_3a){
if(!_3c){
return;
}
var _3d=objj_msgSend(_3c,"allKeys");
for(var i=0,_3f=objj_msgSend(_3d,"count");i<_3f;i++){
var _40=_3d[i];
objj_msgSend(_3a,"setObject:forKey:",objj_msgSend(_3c,"objectForKey:",_40),_40);
}
}
}),new objj_method(sel_getUid("description"),function(_41,_42){
with(_41){
var _43="CPDictionary {\n";
var i=_keys.length;
while(i--){
_43+=_keys[i]+":"+objj_msgSend(_buckets[_keys[i]],"description")+"\n";
}
_43+="}";
return _43;
}
})]);
class_addMethods(_2,[new objj_method(sel_getUid("alloc"),function(_45,_46){
with(_45){
return new objj_dictionary();
}
}),new objj_method(sel_getUid("dictionary"),function(_47,_48){
with(_47){
return objj_msgSend(objj_msgSend(_47,"alloc"),"init");
}
}),new objj_method(sel_getUid("dictionaryWithDictionary:"),function(_49,_4a,_4b){
with(_49){
return objj_msgSend(objj_msgSend(_49,"alloc"),"initWithDictionary:",_4b);
}
}),new objj_method(sel_getUid("dictionaryWithObject:forKey:"),function(_4c,_4d,_4e,_4f){
with(_4c){
return objj_msgSend(objj_msgSend(_4c,"alloc"),"initWithObjects:forKeys:",[_4e],[_4f]);
}
}),new objj_method(sel_getUid("dictionaryWithObjects:forKeys:"),function(_50,_51,_52,_53){
with(_50){
return objj_msgSend(objj_msgSend(_50,"alloc"),"initWithObjects:forKeys:",_52,_53);
}
}),new objj_method(sel_getUid("dictionaryWithJSObject:"),function(_54,_55,_56){
with(_54){
return objj_msgSend(_54,"dictionaryWithJSObject:recursively:",_56,NO);
}
}),new objj_method(sel_getUid("dictionaryWithJSObject:recursively:"),function(_57,_58,_59,_5a){
with(_57){
var _5b=objj_msgSend(objj_msgSend(_57,"alloc"),"init");
for(var key in _59){
var _5d=_59[key];
if(_5a&&_5d.constructor===Object){
_5d=objj_msgSend(CPDictionary,"dictionaryWithJSObject:recursively:",_5d,YES);
}
objj_msgSend(_5b,"setObject:forKey:",_5d,key);
}
return _5b;
}
})]);
...
with(_5e){
return objj_msgSend(_60,"_decodeDictionaryOfObjectsForKey:","CP.objects");
}
}),new objj_method(sel_getUid("encodeWithCoder:"),function(_61,_62,_63){
with(_61){
objj_msgSend(_63,"_encodeDictionaryOfObjects:forKey:",_61,"CP.objects");
}
})]);
...
var _7f=objj_msgSend(_7a,"classForKeyedArchiver"),_80=nil;
if((_7f===_11)||(_7f===_12)){
_80=_7d;
}else{
...
p;19;CPKeyedUnarchiver.ji;8;CPNull.ji;9;CPCoder.jc;8074;
...
class_addIvars(_b,[new objj_ivar("_delegate"),new objj_ivar("_delegateSelectors"),new objj_ivar("_data"),new objj_ivar("_replacementClasses"),new objj_ivar("_objects"),new objj_ivar("_archive"),new objj_ivar("_plistObject"),new objj_ivar("_plistObjects")]);
...
}),new objj_method(sel_getUid("_decodeDictionaryOfObjectsForKey:"),function(_13,_14,_15){
with(_13){
var _16=objj_msgSend(_plistObject,"objectForKey:",_15);
if(objj_msgSend(_16,"isKindOfClass:",_9)){
var key,_18=objj_msgSend(_16,"keyEnumerator"),_19=objj_msgSend(CPDictionary,"dictionary");
while(key=objj_msgSend(_18,"nextObject")){
objj_msgSend(_19,"setObject:forKey:",_1a(_13,objj_msgSend(objj_msgSend(_16,"objectForKey:",key),"objectForKey:",_CPKeyedArchiverUIDKey)),key);
}
return _19;
}
return nil;
}
}),new objj_method(sel_getUid("decodeBoolForKey:"),function(_1b,_1c,_1d){
with(_1b){
return objj_msgSend(_1b,"decodeObjectForKey:",_1d);
}
}),new objj_method(sel_getUid("decodeFloatForKey:"),function(_1e,_1f,_20){
with(_1e){
return objj_msgSend(_1e,"decodeObjectForKey:",_20);
}
}),new objj_method(sel_getUid("decodeDoubleForKey:"),function(_21,_22,_23){
with(_21){
return objj_msgSend(_21,"decodeObjectForKey:",_23);
}
}),new objj_method(sel_getUid("decodeIntForKey:"),function(_24,_25,_26){
with(_24){
return objj_msgSend(_24,"decodeObjectForKey:",_26);
}
}),new objj_method(sel_getUid("decodePointForKey:"),function(_27,_28,_29){
with(_27){
var _2a=objj_msgSend(_27,"decodeObjectForKey:",_29);
if(_2a){
return CPPointFromString(_2a);
}else{
return CPPointMake(0,0);
}
}
}),new objj_method(sel_getUid("decodeRectForKey:"),function(_2b,_2c,_2d){
with(_2b){
var _2e=objj_msgSend(_2b,"decodeObjectForKey:",_2d);
if(_2e){
return CPRectFromString(_2e);
}else{
return CPRectMakeZero();
}
}
}),new objj_method(sel_getUid("decodeSizeForKey:"),function(_2f,_30,_31){
with(_2f){
var _32=objj_msgSend(_2f,"decodeObjectForKey:",_31);
if(_32){
return CPSizeFromString(_32);
}else{
return CPSizeMake(0,0);
}
}
}),new objj_method(sel_getUid("decodeObjectForKey:"),function(_33,_34,_35){
with(_33){
var _36=objj_msgSend(_plistObject,"objectForKey:",_35);
if(objj_msgSend(_36,"isKindOfClass:",_9)){
return _1a(_33,objj_msgSend(_36,"objectForKey:",_CPKeyedArchiverUIDKey));
}else{
if(objj_msgSend(_36,"isKindOfClass:",objj_msgSend(CPNumber,"class"))||objj_msgSend(_36,"isKindOfClass:",objj_msgSend(CPData,"class"))){
return _36;
}else{
if(objj_msgSend(_36,"isKindOfClass:",_7)){
var _37=0,_38=_36.length,_39=[];
for(;_37<_38;++_37){
_39[_37]=_1a(_33,objj_msgSend(_36[_37],"objectForKey:",_CPKeyedArchiverUIDKey));
}
return _39;
}
}
...
}),new objj_method(sel_getUid("decodeBytesForKey:"),function(_3a,_3b,_3c){
with(_3a){
var _3d=objj_msgSend(_3a,"decodeObjectForKey:",_3c);
if(objj_msgSend(_3d,"isKindOfClass:",objj_msgSend(CPData,"class"))){
return _3d.bytes;
}
return nil;
}
...
}),new objj_method(sel_getUid("setClass:forClassName:"),function(_45,_46,_47,_48){
with(_45){
objj_msgSend(_replacementClasses,"setObject:forKey:",_47,_48);
}
}),new objj_method(sel_getUid("classForClassName:"),function(_49,_4a,_4b){
with(_49){
return objj_msgSend(_replacementClasses,"objectForKey:",_4b);
}
}),new objj_method(sel_getUid("allowsKeyedCoding"),function(_4c,_4d){
with(_4c){
return YES;
}
})]);
class_addMethods(_c,[new objj_method(sel_getUid("initialize"),function(_4e,_4f){
with(_4e){
if(_4e!=objj_msgSend(CPKeyedUnarchiver,"class")){
return;
}
...
}),new objj_method(sel_getUid("unarchiveObjectWithData:"),function(_50,_51,_52){
with(_50){
var _53=objj_msgSend(objj_msgSend(_50,"alloc"),"initForReadingWithData:",_52),_54=objj_msgSend(_53,"decodeObjectForKey:","root");
objj_msgSend(_53,"finishDecoding");
return _54;
}
}),new objj_method(sel_getUid("unarchiveObjectWithFile:"),function(_55,_56,_57){
with(_55){
}
}),new objj_method(sel_getUid("unarchiveObjectWithFile:asynchronously:"),function(_58,_59,_5a,_5b){
with(_58){
}
})]);
var _1a=function(_5c,_5d){
var _5e=_5c._objects[_5d];
if(_5e){
if(_5e==_5c._objects[0]){
return nil;
}else{
return _5e;
}
}
var _5e,_5f=_5c._plistObjects[_5d];
if(objj_msgSend(_5f,"isKindOfClass:",_9)){
var _60=_5c._plistObjects[objj_msgSend(objj_msgSend(_5f,"objectForKey:",_CPKeyedArchiverClassKey),"objectForKey:",_CPKeyedArchiverUIDKey)],_61=objj_msgSend(_60,"objectForKey:",_CPKeyedArchiverClassNameKey),_62=objj_msgSend(_60,"objectForKey:",_CPKeyedArchiverClassesKey),_63=objj_msgSend(_5c,"classForClassName:",_61);
if(!_63){
_63=CPClassFromString(_61);
}
_5e=objj_msgSend(_63,"alloc");
_5c._objects[_5d]=_5e;
var _64=_5c._plistObject;
_5c._plistObject=_5f;
var _65=_61;
var _66=objj_msgSend(_5e,"initWithCoder:",_5c);
_5c._plistObject=_64;
if(_66!=_5e){
if(_5c._delegateSelectors&_3){
objj_msgSend(_5c._delegate,"unarchiver:willReplaceObject:withObject:",_5c,_5e,_66);
}
_5e=_66;
_5c._objects[_5d]=_66;
}
_66=objj_msgSend(_5e,"awakeAfterUsingCoder:",_5c);
if(_66!=_5e){
if(_5c._delegateSelectors&_3){
objj_msgSend(_5c._delegate,"unarchiver:willReplaceObject:withObject:",_5c,_5e,_66);
}
...
if(_5c._delegate){
if(_5c._delegateSelectors&_2){
_66=objj_msgSend(_5c._delegate,"unarchiver:didDecodeObject:",_5c,_5e);
}
if(_66!=_5e){
if(_5c._delegateSelectors&_3){
objj_msgSend(_5c._delegate,"unarchiver:willReplaceObject:withObject:",_5c,_5e,_66);
...
_5c._objects[_5d]=_5e=_5f;
if(objj_msgSend(_5e,"class")==_8){
if(_5e==_6){
_5c._objects[_5d]=_5c._objects[0];
return nil;
}else{
_5c._objects[_5d]=_5e=_5f;
}
...
if(objj_msgSend(_5e,"isMemberOfClass:",_a)){
_5e=objj_msgSend(_5e,"JSObject");
}
return _5e;
};
...
with(_73){
return class_getInstanceMethod(_73,_75);
}
...
p;10;CPString.ji;10;CPObject.ji;13;CPException.ji;18;CPSortDescriptor.ji;9;CPValue.jc;8971;
...
with(_8e){
var _91=String(_90);
return "000000".substring(0,MAX(6-_91.length,0))+_91;
}
}),new objj_method(sel_getUid("stringWithString:"),function(_92,_93,_94){
with(_92){
if(!_94){
objj_msgSend(CPException,"raise:reason:",CPInvalidArgumentException,"stringWithString: the string can't be 'nil'");
}
return objj_msgSend(objj_msgSend(_92,"alloc"),"initWithString:",_94);
}
}),new objj_method(sel_getUid("stringWithFormat:"),function(_95,_96,_97){
with(_95){
if(!_97){
objj_msgSend(CPException,"raise:reason:",CPInvalidArgumentException,"initWithFormat: the format can't be 'nil'");
}
...
var _3=_2.isa;
class_addMethods(_2,[new objj_method(sel_getUid("objectFromJSON"),function(_98,_99){
with(_98){
return CPJSObjectCreateWithJSON(_98);
}
})]);
class_addMethods(_3,[new objj_method(sel_getUid("JSONFromObject:"),function(_9a,_9b,_9c){
with(_9a){
return CPJSObjectCreateJSON(_9c);
}
})]);
var _2=objj_getClass("CPString");
if(!_2){
...
var _3=_2.isa;
class_addMethods(_3,[new objj_method(sel_getUid("UUID"),function(_9d,_9e){
with(_9d){
var g="";
for(var i=0;i<32;i++){
...
p;17;CPURLConnection.ji;10;CPObject.ji;11;CPRunLoop.ji;14;CPURLRequest.ji;15;CPURLResponse.jc;4358;
...
if(!_isCanceled){
if(_20==200||(_20===0&&_isLocalFileConnection)){
...
objj_msgSend(_delegate,"connection:didFailWithError:",_1e,_XMLHTTPRequest.status);
}
}
}
}
