@STATIC;1.0;p;13;CPArray+KVO.ji;9;CPArray.jc;14650;
{
...
{ with(self)
{
    ...
    objj_msgSend(_self, "_setRepresentedObject:", target);
}
...
{ with(self)
{
    if (objj_msgSend(isa, "instanceMethodForSelector:", _cmd)==objj_msgSend(NSArray, "instanceMethodForSelector:", _cmd))
...
p;9;CPArray.ji;10;CPObject.ji;9;CPRange.ji;14;CPEnumerator.ji;18;CPSortDescriptor.ji;13;CPException.jc;25523;
...
}), new objj_method(sel_getUid("hash"), function $CPArray__hash(self, _cmd)
{ with(self)
{
...
p;20;CPAttributedString.jI;21;Foundation/CPObject.jI;21;Foundation/CPString.jc;19861;
...
{ with(self)
{
    ...
    var startingIndex = objj_msgSend(self, "_indexOfEntryWithIndex:", aRange.location),
        ...
        endingIndex = objj_msgSend(self, "_indexOfEntryWithIndex:", CPMaxRange(aRange)-1),
...
p;10;CPBundle.ji;10;CPObject.ji;14;CPDictionary.ji;14;CPURLRequest.jc;4138;
...
{ with(self)
{
    if (aConnection === self._infoConnection)
    {
        ...
        objj_msgSend(CPURLConnection, "connectionWithRequest:delegate:", objj_msgSend(CPURLRequest, "requestWithURL:", objj_msgSend(self, "bundlePath") + "/" + objj_msgSend(self, "objectForInfoDictionaryKey:", "CPBundleExecutable")), self);
    }
    else
    {
        ...
        var files = objj_msgSend(self, "objectForInfoDictionaryKey:", "CPBundleReplacedFiles"),
            count = files.length;
        while (count--)
            context.pushFragment(fragment_create_file(objj_msgSend(self, "bundlePath") + '/' + files[count], new objj_bundle(""), YES, NULL));
        context.evaluate();
    }
}
...
p;14;CPCountedSet.ji;7;CPSet.jc;1789;
...
p;8;CPDate.ji;10;CPObject.ji;10;CPString.jc;4306;
...
p;14;CPDictionary.ji;10;CPObject.ji;14;CPEnumerator.ji;13;CPException.jc;8557;
...
{ with(self)
{
    ...
    while (index--)
    {
        ...
        if (lhsObject === rhsObject)
            continue;
        if (objj_msgSend(lhsObject, "respondsToSelector:", sel_getUid("isEqual:")) && objj_msgSend(lhsObject, "isEqual:", rhsObject))
            continue;
        return NO;
    }
    return YES;
...
{ with(self)
{
    if (!aDictionary)
        return;
    var allKeys = objj_msgSend(aDictionary, "allKeys");
    for (var i=0, count = objj_msgSend(allKeys, "count"); i<count; i++)
    {
        var thisKey = allKeys[i];
        objj_msgSend(self, "setObject:forKey:", objj_msgSend(aDictionary, "objectForKey:", thisKey), thisKey);
    }
}
...
p;13;CPException.ji;9;CPCoder.ji;10;CPObject.ji;10;CPString.jc;4186;
...
p;17;CPKeyedArchiver.ji;8;CPData.ji;9;CPCoder.ji;9;CPArray.ji;10;CPString.ji;10;CPNumber.ji;14;CPDictionary.ji;9;CPValue.jc;16073;
...
p;19;CPKeyedUnarchiver.ji;8;CPNull.ji;9;CPCoder.jc;12803;
...
p;18;CPKeyValueCoding.ji;9;CPArray.ji;10;CPObject.ji;14;CPDictionary.jc;8588;
...
p;10;CPNumber.ji;10;CPObject.ji;15;CPObjJRuntime.jc;8499;
...
}), new objj_method(sel_getUid("hash"), function $CPNumber__hash(self, _cmd)
{ with(self)
{
...
p;10;CPObject.jc;8737;{var the_class = objj_allocateClassPair(Nil, "CPObject"),
...
p;10;CPString.ji;10;CPObject.ji;13;CPException.ji;18;CPSortDescriptor.ji;9;CPValue.jc;12679;
...
}), new objj_method(sel_getUid("hash"), function $CPString__hash(self, _cmd)
{ with(self)
{
...
p;17;CPURLConnection.ji;10;CPObject.ji;11;CPRunLoop.ji;14;CPURLRequest.ji;15;CPURLResponse.jc;6406;
...
p;14;CPURLRequest.ji;10;CPObject.jc;2671;
...
p;9;CPValue.ji;10;CPObject.ji;9;CPCoder.jc;5011;
